...
1. Скачать [FRONT](https://github.com/frepingod/netology-cloud-storage-front) (JavaScript) и распаковать его в локальную папку;
...
1. Загружать произвольные файлы (размером до 1 МБайт);
